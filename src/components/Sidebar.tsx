...
export default function Sidebar() {
  const topPosts = getSortedPostsData().slice(0, 3)

  return (
    <div className="w-72 lg:flex-shrink-0 lg:sticky lg:top-4 lg:h-fit mb-8" id="left-sidebar">
      {/* Mobile Menu Toggle - Completely hidden in new responsive design */}
      <button id="mobile-menu-toggle" className="hidden">
      ...
      <div className="mb-2 flex justify-center">
        <picture>
          <source srcSet="/assets/profile-optimized.webp" type="image/webp" />
          <img src="/assets/profile-optimized.jpg"
            alt="Profile"
            loading="lazy"
            decoding="async"
            width="160"
      ...
      {/* Mobile: Name, Location, and Social Icons (below image) */}
